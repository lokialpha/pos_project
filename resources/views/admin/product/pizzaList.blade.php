        ...
        <div class="section__content section__content--p30">
            <div class="container-fluid">
                <div class="col-md-12">
                    ...
                    <div class="table-data__tool">
                        <div class="table-data__tool-left">
                            <div class="overview-wrap">
                                <h2 class="title-1">Porducts List</h2>
                    ...
                    <div class="row">
                        <div class="col-3">
                            <h3><i class="fa-solid fa-folder-open mr-2"></i> {{ $pizzas->total() }}</h3>
                        </div>
                                    ...
                                    <tr class="tr-shadow">
                                        ...
                                        <td class="col-2">
                                            <div class="table-data-feature">
                                                <a href="{{ route('product#edit',$p->id) }}" class="me-2">
                                                    <button class="item" data-toggle="tooltip" data-placement="top" title="View">
                                                        <i class="zmdi zmdi-eye"></i>
                                                    </button>
                                                </a>
                                                <a href="{{ route('product#updatePage',$p->id) }}" class="me-2">
                    ...
                    @else
                        <h3 class=" text-secondary text-sm-center mt-5">There is no Pizza Here!</h3>
                    @endif
                    <!-- END DATA TABLE -->
                </div>
            </div>
